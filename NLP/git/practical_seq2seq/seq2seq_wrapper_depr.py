...
# Had some trouble with an error saying 'can't pickle _thread.lock objects'
# Reverting to https://github.com/Jatapiaro/TwinkerBot_Revival
...
model = Seq2Seq(xseq_len=xseq_len, yseq_len=yseq_len,xvocab_size=xvocab_size,yvocab_size=yvocab_size,
                ckpt_path=r'D:\data\text\Twitter\\', emb_dim=emb_dim,num_layers=3)
...
class Seq2Seq(object):
    ...
    def __graph__(self):
        ...
        basic_cell = tf.nn.rnn_cell.DropoutWrapper(tf.nn.rnn_cell.BasicLSTMCell(self.emb_dim, state_is_tuple=True),
